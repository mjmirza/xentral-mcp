...
function healthResponse(): Response {
  return Response.json({
    ...
    disclaimer:
      "Independent, unofficial connector. Not affiliated with, endorsed by, or sponsored by Xentral ERP Software GmbH. Xentral is a trademark of Xentral ERP Software GmbH, used nominatively to state API compatibility only. To request removal of any reference, contact support@next8n.com.",
  }, {
